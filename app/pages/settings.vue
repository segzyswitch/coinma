...
<template>
  ...
  <section class="container-fluid bg-dark round-15 reciept py-2 px-0">
    ...
    <div class="w-100 p-3 d-flex justify-content-between text-mid border-bottom reciept-item">
      ...
      <div class="my-auto text-muted">{{ user?.name }} <b>></b></div>
    </div>
    <div class="w-100 p-3 d-flex justify-content-between text-mid border-bottom reciept-item">
      <div class="my-auto">Email</div>
      <div class="my-auto text-muted">{{ user?.email }} <b>></b></div>
    </div>
    <div class="w-100 p-3 d-flex justify-content-between text-mid border-bottom reciept-item">
      <div class="my-auto">Phone number</div>
      <div class="my-auto text-muted">{{ user?.phone }} <b>></b></div>
    </div>
    <div class="w-100 p-3 d-flex justify-content-between text-mid border-bottom reciept-item">
      <div class="my-auto">Address</div>
      <div class="my-auto text-muted">{{ user?.address }} <b>></b></div>
    </div>
    <div class="w-100 p-3 d-flex justify-content-between text-mid border-bottom reciept-item">
    ...
    <div class="w-100 p-3 d-flex justify-content-between text-mid border-bottom reciept-item">
      ...
      <div class="my-auto text-muted">******** <b>></b></div>
    </div>
  </section>
