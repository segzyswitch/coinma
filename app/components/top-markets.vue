...
<template>
  ...
  <section class="p-3 bg-dark round-15 mb-3" v-else>
    ...
    <div class="w-100 overflow-auto d-flex gap-3 hidden-scroll">
      <router-link :to="`/market/${asset.slug}`" class="col-9 col-sm-5 pb-3 top-asset" v-for="(asset, idx) in allAssets.slice(0,3)" :key="idx">
...
<style>
.top-asset { text-decoration: none!important; }
